...
int main(int argc, char *argv[])
{
    ...
    size_t vecSizeBytes = vecSize * sizeof(unsigned char);
...
//    program = cl::Program(context, sources);
        ...
        cl::Context context(CL_DEVICE_TYPE_ACCELERATOR, cps);
    
        std::string binary_file = aocl_utils::getBoardBinaryFile("kernels", device());
        printf("Using AOCX: %s\n", binary_file.c_str());
        cl::Program program;
    ...
    cl::Buffer d_frame_in(context, CL_MEM_READ_WRITE | CL_MEM_COPY_HOST_PTR, vecSizeBytes, h_frame_in.data());
    cl::Buffer d_frame_out(context, CL_MEM_READ_WRITE, vecSizeBytes);
